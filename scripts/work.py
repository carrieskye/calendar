    ...
    def run(self):
        ...
        while self.day <= self.end:
            if self.day.weekday() == 7 or self.day.weekday() < 5:
                ...
                self.create_event(self.cal_id_work_partner, 'Amplyfi', 'Tramshed', '', time(10), time(12, 30))
                ...
                self.create_event(self.cal_id_work_partner, 'Amplyfi', 'Tramshed', '', time(13, 30), time(18))
