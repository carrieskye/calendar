...
class UpdateHours(Work):
    ...
    def run(self):
        ...
        while day < self.end:
            ...
            activities = [Activity.from_dict(x, GeoLocations.home_uk.time_zone) for x in Utils.read_csv(file_name)]
            ...
            events = GoogleCalAPI.get_events(Calendars.work, Owner.user, 1000, self.start,
