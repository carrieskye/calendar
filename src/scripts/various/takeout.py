...
#         start_date = None
#         day_locations = []
#         location = Utils.read_json('data/location_history/takeout.json').get('location')
...
#             if date < start_date and location != location[-1]:
...
#         start_date = None
#         day_locations = []
#         location = Utils.read_json('takeout.json').get('location')
#
#         for location in location:
