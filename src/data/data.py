...
from src.data.locations import LocationDict
...
class Locations:
    bromsgrove_st = Data.location_dict['bromsgrove_st']
    tramshed_tech = Data.location_dict['tramshed_tech']
    viola_arena = Data.location_dict['viola_arena']
